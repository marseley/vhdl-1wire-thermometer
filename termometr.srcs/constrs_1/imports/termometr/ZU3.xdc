...
set_property PACKAGE_PIN AF5 [get_ports {Read_Out_0}]
...
set_property IOSTANDARD LVCMOS12 [get_ports Read_Out_0]
...
#set_property PACKAGE_PIN A10 [get_ports {IOBUF_IO_IO_0[0:0]}]
...
#set_property IOSTANDARD LVCMOS33 [get_ports IOBUF_IO_IO_0[0:0]]
